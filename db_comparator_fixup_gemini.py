        ...
        with oracledb.connect(
            ...
            for i, (src_name, tgt_name, obj_type) in enumerate(master_list):
                ...
                if obj_type_u == 'TABLE':
                    ...
                    src_cols_details = oracle_get_column_details(ora_conn, src_schema, src_obj)
                    tgt_cols_details = ob_meta.tab_columns.get((tgt_schema.upper(), tgt_obj.upper()), {})
    ...
    try:
        with oracledb.connect(
            ...
            for seq_mis in extra_results.get('sequence_mismatched', []):
                ...
                src_schema, tgt_schema = src_schema.upper(), tgt_schema.upper()
            ...
            for (obj_type, tgt_name, missing_cols, extra_cols, length_mismatches) in tv_results.get('mismatched', []):
                ...
                alter_sql = generate_alter_for_table_columns(
                    ora_conn, src_schema, src_table, tgt_schema, tgt_table,
...
def print_final_report(
    ...
    print_ext_mismatch_table(
        ...
        lambda item: (
            Text(item.schema, style="mismatch"),
