## 1. Implementation
- [x] 1.1 Add config key for synonym fixup scope (default=all) and validate values
- [x] 1.2 Apply synonym scope filter in fixup generation, ensuring no duplicate or contradictory filtering
